<div class="bloco list" style="display:block">
			...
			if(isset($_GET['update'])){
				...
				endforeach;
                $update = mysql_query("update  videos set  public='$pu' where id='$atu' ");
				if(!$update){
						...
						echo $msg;
						header('location:index2.php?exe=videos/listas_video');
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="center"><img src="../upload/videos/<?php echo $bus['foto']; ?>" height="80" width="80"></td>
                    <td align="center"><a href="index2.php?exe=videos/editar_videos&id=<?php echo $bus['id'] ?>" title="editar"><img src="ico/edit.png" alt="editar" title="editar" /></a></td>
                    <td align="center"><a href="index2.php?exe=videos/listas_video&del=<?php echo $bus['id'] ?>" title="editar"><img src="ico/no.png" alt="editar" title="excluir" /></a></td>
                    <td align="center"><a href="index2.php?exe=videos/listas_video&update=<?php echo $bus['id'] ?>" title="publicar"><img src="ico/<?php echo $img ?>" alt="<?php echo $ale ?>" title="<?php echo $ale ?>" /></a></td>
                  </tr>
                  <?php endforeach;
				  }
				  ?>
