...
<div class="bloco list" style="display:block">
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
				  ...
				  $pastat = '../upload/galeria/album/';;
				  $pasta =  '../upload/galeria/';
                  if(!in_array($type,$permitido)){

				  }else{					
		          
				  $update = mysql_query("update   galeria set  foto='$nome' where id='$id' ");
				 
				  //upload($tmp ,$nome,600,$pasta);
				  //upload($tmp ,$nome,200,$pastat);
				  move_uploaded_file($tmp,$pasta.$nome);
				  move_uploaded_file($tmp,$pastat.$nome);
				  if($update){				 
				  ...
				  $galeria = read('galeria',"where id_pai='$id'", "  LIMIT  $inicio , $maximo");
				  if(!$galeria){
                  ...
                  <tr>
                    ...
                    <td align="center"><image src="../upload/album/<?php echo $gal['foto']?>" height="50" width="50"></td>
			  ...
			  <td align="center">
				  ...
				  <input type="file" name='nome' width="" />
				   ...
				   <input type="submit" name="atu"  >
                    ...
                    <td align="center"><a href="index2.php?exe=posts/gal_edit&publ=" title="publicar"><img src="ico/view.png" alt="publicar" title="publicar" /></a></td>
                  </tr>
                  <?php 
