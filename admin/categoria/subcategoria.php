			...
			<a href="" title="deslogar" class="btnalt">create</a>
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
				 ...
				 $busca = read('up_cat'," WHERE id_pai IS  not null LIMIT $inicio, $maximo"); 
                          if(!$busca){
                    ...
                    <td align="center"><a href="index2.php?exe=categoria/edica&id=<?php echo $bus['id'] ?>" title="editar"><img src="ico/edit.png" alt="editar" title="editar" /></a></td>
                    <td align="center"><a href="index2.php?exe=categoria/apartcat&del_pai=<?php echo $bus['id'] ?>" title="editar"><img src="ico/no.png" alt="editar" title="excluir" /></a></td>
                  </tr>
                  <?php 
