<div class="bloco list" style="display:block">
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
				  ...
				  $update = mysql_query("update   publi_roda set  r_dois='$nome' where id='$id' ");				 
				  ...
				  $galeria = read('publi_roda',"where id='$id'", "  LIMIT  $inicio , $maximo");
				  if(!$galeria){
                  ...
                  <tr>
                    ...
                    <td align="center"><image src="upload/publi/<?php echo $gal['r_dois']?>" height="50" width="50"></td>
				   ...
				   <input type="submit" name="atu"  >
                    ...
                    <td align="center"><a href="index2.php?exe=publi/edit_ro_update&id=<?php echo $gal['id_pai']?>&del=<?php echo $gal['id']?>" title="editar"><img src="ico/no.png" alt="excluir" title="excluir" /></a></td>
                    <td align="center"><a href="index2.php?exe=publi/gal_edit&publ=" title="publicar"><img src="ico/view.png" alt="publicar" title="publicar" /></a></td>
                  </tr>
                  <?php 
                ...
                <div class="paginator">
				<?php
                $link = 'index2.php?exe=publi/gal_ed&id=';
