<div class="bloco list" style="display:block">
            	<div class="titulo">Publicidade parceiros:
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
				  ...
				  $galeria = read('publicidade', "  LIMIT  $inicio , $maximo");
				   if(!$galeria){
                  ...
                  <tr>
                    ...
                    <td align="center"><img src="../upload/publi/<?php echo $gal['publium']?>" height="80" width="80"></a></td>
                    <td align="center"><<?php echo $gal['publium']?></td>
					
                    <td align="center"><a href="index2.php?exe=publi/pu_edit&id=<?php echo $gal['id']?>" title="editar"><img src="ico/edit.png" alt="Enviar imagem" title="editar" /></a></td>
                    <td align="center"><a href="index2.php?exe=publi/pu_edit&del=<?php echo $gal['id']?>" title="editar"><img src="ico/no.png" alt="excluir" title="excluir" /></a></td>
                    <td align="center"><a href="index2.php?exe=publi/gal_ed&id=<?php echo $gal['id']?>" title="visualisar fotos"><img src="ico/view.png" alt="visualisar fotos" title="visualisar fotos" /></a></td>
                  </tr>
                  <?php 
                ...
                <div class="paginator">
                	<?php
                $link = 'index2.php?exe=publi/pu_edit&id=';
