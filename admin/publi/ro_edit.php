<div class="bloco list" style="display:block">
                ...
                <table width="560" border="0" class="tbdados" style="float:left;" cellspacing="0" cellpadding="0">
				  ...
				  ?>
                  <tr>
                    <td><a href="#" target="_blank"><?php echo $gal['r_um']?></a></td>
                    <td align="center"><?php echo date('d/m/Y')?></td>
                    <td align="center"><img src="upload/publi/<?php echo $gal['r_um']?>" height="80" width="80"></a></td>
                    <td align="center"><<?php echo $gal['r_um']?></td>
					
					
					
                    <td align="center"><a href="index2.php?exe=publi/ro_edit&id=<?php echo $gal['id']?>" title="editar"><img src="ico/edit.png" alt="Enviar imagem" title="editar" /></a></td>
                    <td align="center"><a href="index2.php?exe=publi/ro_edit&del=<?php echo $gal['id']?>" title="editar"><img src="ico/no.png" alt="excluir" title="excluir" /></a></td>
                    <td align="center"><a href="index2.php?exe=publi/edit_ro&id=<?php echo $gal['id']?>" title="visualisar fotos"><img src="ico/view.png" alt="visualisar fotos" title="visualisar fotos" /></a></td>
                  </tr>
