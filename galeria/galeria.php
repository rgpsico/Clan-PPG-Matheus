	...
	<ul>
		...
		<?php 
					...
					$id = $_GET['id'];
                     ...
                     $gal = mysql_query("select id , foto ,nome from galeria where id_pai = '$id' LIMIT  $inicio , $maximo ");
...
<a class="vlightbox1" href="admin/upload/album/<?php echo $ga['foto']?>"  title="">
	
<img src="admin/upload/album/<?php echo $ga['foto']?>"  height="120" width="170"  alt=""/>
</a>
</li>
	...
	<?php
	                    $id = $_GET['id'];
					     ...
					     $link = 'http://127.0.0.1/matheus/schedule-single.php?id='.$id.'&pag=';
